...
$(document).ready(function() {
    ...
    $('.profits-rotate').on('animateIn', function() {
        var inter = 0;
        $(this).find('.anim-r').each(function() {
            var block = $(this);
            setTimeout(function() {
                block.css('opacity', 1);
                block.css('transform', 'scale(1.0, 1.0)');
                block.css('transform', 'rotate(720deg)');
            }, inter*100);
            inter++;
        });
    }).on('animateOut', function() {
    ...
    show_popup('.call a', '.popup .call-form');
