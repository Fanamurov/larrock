$(document).ready(function(){
    ...
    $('.toursBlockCategory').css('height', '187px');
    $('.toursBlockTour').css('height', '187px');
    $('.blog-item-module').css('height', '187px');
    $('.news-item-module').css('height', '187px');
    $('.bestcost-row').css('height', '187px');
    $('.search-result-photo').css('height', '187px');
