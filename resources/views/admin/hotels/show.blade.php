...
@section('content')
    <div class="ibox float-e-margins">
        <div class="ibox-title background-transparent">
            {!! Breadcrumbs::render('admin.hotels.category', $data) !!}
            <a href="/{{ $app['name'] }}/{{ $data->url }}">/{{ $app['name'] }}/{{ $data->url }}</a>
            <div class="add-panel">
                <a class="btn btn-info pull-right" href="/admin/{{ $app['name'] }}/create?category={{ $data->id }}">Добавить отель</a>
                ...
                @else
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr class="table-row-up">
                            <td>
                                <a href="{{ $data->get_parent->url or '/admin/hotels' }}" style="font-size: 22px">
        ...
        <div class="ibox-content">
            ...
            @else
                ...
                <table class="table table-striped table-hover">
                    ...
                    @include('admin.hotels.include-list-tovars', array('data' => $data->get_hotels, 'app' => $app))
                    </tbody>
                </table>
                {!! $paginator->render() !!}
            @endif
