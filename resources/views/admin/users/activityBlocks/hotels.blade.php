...
@foreach($data as $data_value)
    ...
    AND ($data_value->actual < \Carbon\Carbon::now()))) class="danger" title="Отель не актуален" @endif>
        <td width="110">
        ...
        <td class="row-delete">
            <form action="/admin/hotels/{{ $data_value->id }}" method="post">
