<h1 style="font:26px/32px Calibri,Helvetica,Arial,sans-serif;">Заказан подбор тура на сайте santa-avia.ru</h1>
...
<p style="font:14px/16px Calibri,Helvetica,Arial,sans-serif;"><strong>Интересующая страна:</strong> {{ $country }}</p>
<p style="font:14px/16px Calibri,Helvetica,Arial,sans-serif;"><strong>Со мной удобнее связаться:</strong> {{ $time }}</p>
