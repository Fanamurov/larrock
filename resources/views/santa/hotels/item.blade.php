...
@section('content')
    <div class="toursPageItem row">
        @role('admin|moderator')
            <a class="editAdmin" href="/admin/hotels/{{ $data->id }}/edit">Редактировать отель</a>
        @endrole
        <div class="col-xs-24">
            {!! Breadcrumbs::render('hotels.item', $data) !!}
        </div>
        <div class="clearfix"></div>
        <div class="row relative">
            @include('santa.modules.share.sharing', ['type' => 'hotels', 'id' => $data->id])
            <div class="col-xs-24">
                    ...
                    @if(count($data->getImages) > 0)
                        <div id="carousel-tour" class="carousel slide" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators">
                                ...
                                @for($i=1; $i < count($data->getImages); $i++)
        ...
        <div class="row-btn-group">
            <div class="btn-group" role="group">
                ...
                <a href="#form-zakaz" role="button" class="btn btn-default">Забронировать</a>
            </div>
        </div>
        ...
        <div class="row row-form-zakaz">
            @include('santa.modules.forms.zakazHotel')
        </div>
    </div>
@endsection