<div class="row row-zakazTura col-xs-24" id="row-zakazTura" onsubmit="yaCounter27992118.reachGoal('ZakazTura');
ga('send', 'event', 'Форма','Отправка', 'Заказ тура'); return true;">
    <div class="col-sm-12">
