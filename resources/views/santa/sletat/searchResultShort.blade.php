...
<div class="toursPageCountry-bestcost row">
    ...
    <ul class="list-unstyled search-result">
        @foreach($GetTours['aaData'] as $item)
            <li class="col-xs-24 col-sm-12 col-md-6 bestcost-row">
                <div class="col-xs-24">
                    <div class="col-xs-8 col-sm-24 search-result-photo">
                        @if( !empty($item[29]))
                    ...
                    <div class="col-xs-16 col-sm-24">
                        ...
                        <div class="col-sm-24 row">
                            <div class="col-xs-24">{{ $item[33] }} - {{ $item[31] }}</div>
