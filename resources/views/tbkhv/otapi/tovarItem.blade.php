...
@section('content')
    <div class="page-catalog-item">
        ...
        <div class="col-content-item col-xs-24 @if( !isset($data->Vendor->Credit->Level)) col-sm-14 col-md-14 col-md-offset-1 @else col-sm-14 col-md-11 @endif">
            ...
            <br/>
            @if($data->MasterQuantity > 0)
                <p class="text-center button_bg @if(isset($itsConfiguration)) button_bg-disabled @endif" data-toggle="tooltip"
                   data-placement="bottom" title="Если кнопки не активны, пожалуйста, выберите нужные параметры товара (цвет, размер и т.д.)">
                    ...
                    <button class="btn btn-info btn-lg btn-add-to-cart-fast" @if(isset($itsConfiguration)) disabled @endif
                            data-id="{{ $data->Id }}"
                            data-name="{{ $data->OriginalTitle }}"
                            data-price="{{ $default_cost }}"
                            data-config=""
    ...
    <div class="tabs">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="description">
                <div class="col-xs-24">
                    @include('tbkhv.otapi.item.attribute-list')
                </div>
            </div>
            <div role="tabpanel" class="tab-pane" id="opinions">
                <div class="col-xs-24">
                    @include('tbkhv.otapi.item.opinions')
                </div>
            </div>
        </div>
    </div>
